    ...
    <div class="shadow-lg p-6 rounded-lg">
        <form action="/product" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-col mt-3 relative">
                ...
                <input autocomplete="off" type="text" name="qty" inputmode="numeric" pattern="[0-9]*" placeholder="Jhon Doe" id="qty" class="border <?= session("errors.qty") ? "border-red-400" : "border-gray-400" ?> rounded p-2 outline-none placeholder:text-xs" value="<?= old("qty") ?>" />
                <?php if (session("errors.name")): ?>
                    <i class="bi bi-exclamation-triangle text-red-500 absolute bottom-7 right-3"></i>
                <?php endif ?>
