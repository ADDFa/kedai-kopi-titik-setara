...
<section class="container p-2 w-[calc(100%-0.5rem)] lg:w-[calc(100%-120px)] mx-auto mt-4 shadow">
    <h2 class="text-lg font-semibold leading-9 mb-4">PALING DISUKAI</h2>
    <hr class="text-gray-300" />

    <div class="grid lg:grid-cols-3 xl:grid-cols-5 gap-3 mt-4">
...
<section class="container p-2 w-[calc(100%-0.5rem)] lg:w-[calc(100%-120px)] mx-auto shadow mt-8 mb-10">
    <h2 class="text-lg font-semibold leading-9 mb-4 text-center">REKOMENDASI</h2>
    <hr class="text-gray-300" />

    <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-1.5 mt-4">
