    ...
    <div class="shadow p-6 rounded-2xl w-full sm:w-md">
        ...
        <form method="POST" class="mt-5">
            <div class="flex items-center border-b border-b-zinc-400">
                <i class="bi bi-person pe-3 text-2xl text-zinc-400"></i>
                <input autocomplete="off" type="text" placeholder="Nama" name="name" id="name" class="floating-input-icon" value="<?= old("name") ?>" />
            </div>
